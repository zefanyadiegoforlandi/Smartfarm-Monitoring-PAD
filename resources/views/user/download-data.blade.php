...
<script>
    function saveAndSelectFilter(id_sensor) {
        alert('Mengirim data ke server untuk menyimpan filter');
        ...
        .then(data => {
            ...
            alert('Memuat ulang halaman untuk menerapkan filter baru');
    ...
    document.getElementById('downloadForm').addEventListener('submit', function(event) {
        ...
        alert('Formulir dikirim, memeriksa tanggal dan ID sensor');
