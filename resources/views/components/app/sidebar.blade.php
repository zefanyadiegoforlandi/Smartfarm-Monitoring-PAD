<div>
  ...
  <div id="sidebar" class=" bg-white border-r border-gray-300 h-full flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-white p-4 transition-all duration-200 ease-in-out" :class="sidebarOpen ? 'translate-x-0' : '-translate-x-64'" @click.outside="sidebarOpen = false" @keydown.escape.window="sidebarOpen = false" x-cloak="lg">
   ...
   <div class="space-y-8 mb-10">
    <div>
      <ul class="mt-3">
        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(Request::is('/pages/dashboard/admin-dashboard')){{ 'text-[#416D14]' }}@endif">
          <a class="block @if(Request::segment(3) == 'admin-dashboard'){{ 'text-[#416D14]' }}@else{{ 'text-gray-500' }}@endif text-lg truncate transition duration-150 focus:text-slate-200 focus:outline-none @if(Request::segment(1) == 'admin-dashboard'){{ 'hover:text-green-500' }}@endif" href="{{ route('admin-dashboard') }}">
      ...
      <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(Request::is('pages/add/daftar-farmer')){{ 'text-[#416D14]' }}@endif">
        <a class="block @if(Request::segment(3) == 'daftar-farmer'){{ 'text-[#416D14]' }}@else{{ 'text-gray-500' }}@endif text-lg truncate transition duration-150 focus:text-slate-200 focus:outline-none @if(Request::segment(1) == 'daftar-farmer'){{ 'hover:text-green-500' }}@endif" href="{{ route('daftar-farmer') }}">
            <div class="flex items-center justify-between">
                <div class="flex items-center hover:text-[#416D14]" style="filter: brightness(1); transition: filter 0.2s;" onmouseover="this.style.filter='brightness(1.5)'" onmouseout="this.style.filter='brightness(1)'">
                    ...
                    <span class="text-lg font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 hover:text-[#416D14]">Daftar Farmer</span>
                </div>
            </div>
        </a>
      </li>
        ...
        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(Request::is('pages/add/daftar-lahan')){{ 'text-[#416D14]' }}@endif">
          <a class="block @if(Request::segment(3) == 'daftar-lahan'){{ 'text-[#416D14]' }}@else{{ 'text-gray-500' }}@endif text-lg truncate transition duration-150 focus:text-slate-200 focus:outline-none @if(Request::segment(3) == 'daftar-lahan'){{ 'hover:text-green-500' }}@endif" href="{{ route('daftar-lahan') }}">
            <div class="flex items-center justify-between">
              <div class="flex items-center hover:text-[#416D14]" style="filter: brightness(1); transition: filter 0.2s;" onmouseover="this.style.filter='brightness(1.5)'" onmouseout="this.style.filter='brightness(1)'">
                ...
                <span class="text-lg font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 hover:text-[#416D14]">Daftar Lahan</span>
              </div>
            </div>
          </a>
        </li>
  
        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(Request::is('pages/add/daftar-sensor')){{ 'text-[#416D14]' }}@endif">
          <a class="block @if(Request::segment(3) == 'daftar-sensor'){{ 'text-[#416D14]' }}@else{{ 'text-gray-500' }}@endif text-lg truncate transition duration-150 focus:text-slate-200 focus:outline-none @if(Request::segment(3) == 'daftar-sensor'){{ 'hover:text-green-500' }}@endif" href="{{ route('daftar-sensor') }}">
            <div class="flex items-center justify-between">
              <div class="flex items-center hover:text-[#416D14]" style="filter: brightness(1); transition: filter 0.2s;" onmouseover="this.style.filter='brightness(1.5)'" onmouseout="this.style.filter='brightness(1)'">
                <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="text-lg font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 hover:text-[#416D14]">Daftar Sensor</span>
              </div>
            </div>
          </a>
        </li>
