...
<div class="min-w-full px-4 mb-5">
    <span class="toggle-button text-white text-4xl top-5 left-4 cursor-pointer xl:hidden">
        <img src="{{ asset('images/toggle_sidebar.svg') }}">
    </span>
    ...
    <div class="mt-7 md:flex md:shadow-2xl md:rounded">
        <div class="flex-col justify-center items-center md:bg-[#C6D2B9] py-12 md:px-20 text-center">
            <img src="{{ asset('images/user_besar_icon.svg') }}" class="w-40 h-40 overflow-hidden rounded-full mb-4 mx-auto">
            <div>
        ...
        <div class="flex-col flex-1 md:p-9">
            ...
            <div>
                ...
                <table class="w-full">
                    <thead class="bg-[#ECF0E8] text-[#416D14]">
                        <tr>
                            <th class="py-2 px-4 border-b text-left">Nama Lahan (ID Lahan)</th>
                            <th class="py-2 px-4 border-b text-left">Nama Sensor (ID Sensor)</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr>
                                <td class="py-2 px-4 border-b">
                                    <div class="h-full flex items-center">
                                        <span class="w-full text-left">{{ $s['nama_lahan'] }} ({{ $s['id_lahan'] }})</span>
                                    </div>
                                </td>
                                <td class="py-2 px-4 border-b">
                                    <div class="h-full flex items-center">
                                        <span class="w-full text-left">{{ $s['nama_sensor'] }} ({{ $s['id_sensor'] }})</span>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
