...
<div class="container mx-auto px-4 md:px-8 lg:px-16 xl:px-20">
    ...
    <div class="flex items-center justify-start group mt-5">
        ...
        <a href="{{ route('approxaltitude') }}" class="font-medium text-[16px] md:text-[20px] text-[#416D14] ms-1 group-hover:brightness-125 group-active:brightness-150">kembali</a>
    </div>
