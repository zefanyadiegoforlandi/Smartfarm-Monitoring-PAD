...
<div class="container mx-auto px-4 md:px-8 lg:px-16 xl:px-20">
    <div class="mt-5 flex flex-col md:flex-row md:items-center justify-between">
        <div class="flex items-center justify-start">
            ...
            <p class="font-semibold text-3xl md:text-4xl text-[#416D14]">Temperature</p>
        </div>
    ...
    <div class="flex items-center justify-start group mt-5">
        ...
        <a href="{{ route('temperature') }}" class="font-medium text-[16px] md:text-[20px] text-[#416D14] ms-1 group-hover:brightness-125 group-active:brightness-150">kembali</a>
    </div>
        ...
        <table id="airQuality-table" class="w-full">
            <thead class="bg-[#ECF0E8]">
                <tr>
                    ...
                    <th class="p-2 text-[#416D14] uppercase">Temperature</th>
                </tr>
            </thead>
                ...
                @if (count($paginator['data']) > 0)
                    @foreach ($paginator['data'] as $ds)
                        <tr class="{{ $loop->iteration % 2 == 0 ? 'bg-[#ecf0e82e]' : 'bg-white' }}">
                            ...
                            <td class="py-2 px-4 border-b text-center">{{ $ds['Temperature'] }}</td>
                        </tr>
                    @endforeach
                @else
                    <tr>
