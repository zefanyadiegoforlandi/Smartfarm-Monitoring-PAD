        ...
        <div class="mt-7 md:flex md:shadow-2xl md:rounded">
            <div class="flex-col justify-center items-center md:bg-[#C6D2B9] py-20 md:px-20">
                ...
                <div class="flex justify-center space-x-4 mt-4">
                    ...
                    <button type="submit" form="submit-form" class="text-white px-4 py-2 rounded mx-4" style="width: 95px; background-color:#416D14;">Simpan</button>
                </div>
            </div>

            <div class="flex-col flex-1 md:p-9">
                <form id="submit-form" action="{{ route('form-auth.update', ['id' => $user['id']]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST') 
