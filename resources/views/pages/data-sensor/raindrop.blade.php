...
<div class="container mx-auto px-4 md:px-8 lg:px-16 xl:px-20">
    ...
    <div class="flex items-center justify-end group mt-5">
        <a href="{{ route('history.Raindrop') }}" class="font-medium text-[16px] md:text-[20px] text-[#416D14] me-1 group-hover:brightness-125 group-active:brightness-150">lihat selengkapnya</a>
        ...
        <table id="raindrop-table" class="w-full">
            <thead class="bg-[#ECF0E8]">
                <tr>
                    ...
                    <th class="p-2 text-[#416D14] uppercase">Curah Hujan</th>
                </tr>
            </thead>
...
// Memisahkan data label dan intensitas hujan dari data sensor
...
var maxDataValue = Math.max(...raindrop);
var minDataValue = Math.min(...raindrop);
var upperBound = maxDataValue + 5;
var lowerBound = minDataValue - 5;
...
function fetchDataAndUpdateChart() {
    fetch('/update-data-grafik-RainDrop')
        ...
        .then(data => {
            ...
            myChart.options.scales.y.min = newMinDataValue - 5;
            myChart.options.scales.y.max = newMaxDataValue + 5;
