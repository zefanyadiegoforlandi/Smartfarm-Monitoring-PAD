...
<div class="container mx-auto px-4 md:px-8 lg:px-16 xl:px-20">
    <div class="mt-5 flex flex-col md:flex-row md:items-center justify-between">
        <div class="flex items-center justify-start">
            ...
            <p class="font-semibold text-3xl md:text-4xl text-[#416D14]">Kelembapan Tanah</p>
        </div>
    ...
    <div class="flex items-center justify-end group mt-5">
        <a href="{{ route('history.PersentasekelembapanTanah') }}" class="font-medium text-[16px] md:text-[20px] text-[#416D14] me-1 group-hover:brightness-125 group-active:brightness-150">lihat selengkapnya</a>
        ...
        <table id="kelembapanTanah-table" class="w-full">
            <thead class="bg-[#ECF0E8]">
                <tr>
                    ...
                    <th class="p-2 text-[#416D14] uppercase">Kelembapan Tanah</th>
                </tr>
            </thead>
...
// Memisahkan data label dan persentase kelembapan tanah dari data sensor
...
var maxDataValue = Math.max(...kelembapanTanah);
var minDataValue = Math.min(...kelembapanTanah);
