...
<div class="container mx-auto px-4 md:px-8 lg:px-16 xl:px-20">
    ...
    <div class="flex items-center justify-end group mt-5">
        <a href="{{ route('history.Light') }}" class="font-medium text-[16px] md:text-[20px] text-[#416D14] me-1 group-hover:brightness-125 group-active:brightness-150">lihat selengkapnya</a>
...
// Memisahkan data label dan intensitas cahaya dari data sensor
...
var maxDataValue = Math.max(...light);
var minDataValue = Math.min(...light);
